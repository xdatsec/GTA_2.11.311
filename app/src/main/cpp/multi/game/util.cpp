...
{
    return *(PED_TYPE**)Players;
}

PED_TYPE* GamePool_Ped_GetAt(int iID)
{
    // GetPoolPed
    return (( PED_TYPE* (*)(int))(g_libGTASA + 0x546AD0))(iID);
}

int GamePool_Ped_GetIndex(PED_TYPE* pActor)
{
    // GettPoolPedRef
    return ((int (*)(PED_TYPE*))(g_libGTASA + 0x546AC0))(pActor);
}

ENTITY_TYPE *GamePool_Object_GetAt(int iID)
{
    // GetPoolObj
    return ((ENTITY_TYPE* (*)(int))(g_libGTASA + /*0x41DDB4*/0x546AF4))(iID);
}

uintptr_t GamePool_Vehicle_GetIndex(VEHICLE_TYPE* pGtaVehicle)
{
    // GettPoolVehicleRef
    return ((uintptr_t (*)(VEHICLE_TYPE*))(g_libGTASA + 0x546A9C))(pGtaVehicle);
}

VEHICLE_TYPE* GamePool_Vehicle_GetAt(int iID)
{
    // GetPoolVehicle
    return ((VEHICLE_TYPE* (*)(int))(g_libGTASA + 0x546AAC))(iID);
}
...
int GetVehicleSubtype(VEHICLE_TYPE* pGtaVehicle)
{
    if (pGtaVehicle)
    {
        ...
        if (vtable == (g_libGTASA + 0x81A960)) {		// CAutomobile
            return VEHICLE_SUBTYPE_CAR;
        }
        else if (vtable == (g_libGTASA + 0x81AC80)) {	// CBike
            return VEHICLE_SUBTYPE_BIKE;
        }
        else if (vtable == (g_libGTASA + 0x81B350)) {	// CHeli
            return VEHICLE_SUBTYPE_HELI;
        }
        else if (vtable == (g_libGTASA + 0x81B110)) {	// CBoat
            return VEHICLE_SUBTYPE_BOAT;
        }
        else if (vtable == (g_libGTASA + 0x81B820)) {	// CPlane
            return VEHICLE_SUBTYPE_PLANE;
        }
        else if (vtable == (g_libGTASA + 0x81AEC8)) {	// CBmx
            return VEHICLE_SUBTYPE_PUSHBIKE;
        }
        else if (vtable == (g_libGTASA + 0x81BF58)) {	// CTrain
...
uintptr_t GetModelInfoByID(int iModelID)
{
    ...
    uintptr_t *dwModelArray = (uintptr_t*)(g_libGTASA + /*0x87BF48*/0xBBD6A8);
...
{
    uint16_t* p = (uint16_t*)(GetModelInfoByID(iModel) + 30*2);
    return *p;
}
// 0.3.7
bool IsValidPedModel(uint modelID)
{
    if (modelID >= 0 && modelID <= 30000)
    {
        ...
        if (modelInfo)
        {
            if ( (*(uintptr_t*)modelInfo) == (g_libGTASA + 0x80CAA0))
                return true;
        }
    }
...
uintptr_t GetModelRWObject(uint uiModel)
{
    ...
    return *(uintptr_t*)(modelInfo + 0x40); /* pRWObject */
}

uintptr_t GetTexture(const char* texname)
{
    uintptr_t texture = ((uintptr_t(*)(const char*))(g_libGTASA + 0x78700C))(texname);
    if (texture == 0) return 0;
    int count = *(int*)(texture + 0x64);
    count++;
    *(int*)(texture + 0x64) = count;
    return texture;
}
...
uintptr_t LoadTextureFromDB(const char* dbname, const char* texname)
{
    ...
    uintptr_t db_handle = ((uintptr_t(*)(const char*))(g_libGTASA + /*0x1BF530*/0x7884AC))(dbname);
    ...
    ((void(*)(uintptr_t))(g_libGTASA + /*0x1BE898*/0x786EC0))(db_handle);
    ...
    ((void(*)(uintptr_t))(g_libGTASA + /*0x1BE938*/0x786F94))(db_handle);
...
{
    return ((void (*)(void*))(g_libGTASA + 0x4E9ADC))(pRect);
}
RwTexture* LoadTextureFromTxd(const char* txdname, const char* texturename)
{
    ...
    {
        uintptr_t v10 = ((int (*)(const char*))(g_libGTASA + 0x5E5084))(txdname);
        CHook::CallFunction<void>(g_libGTASA + 0x5E551C);
        CHook::CallFunction<void>(g_libGTASA + 0x5E551C, v10, 0);
        tex = CHook::CallFunction<RwTexture*>(g_libGTASA + 0x75D68C, texturename, 0);
        CHook::CallFunction<void>(g_libGTASA + 0x5E554C);
    }
...
int FindTxdSlot(const char* txdname)
{
    ...
    return ((int(*)(const char*))(g_libGTASA + 0x5E5084))(txdname);
}
// 0.3.7 
void PushCurrentTxd()
{
    // CTxdStore::PushCurrentTxd
    ((void (*)())(g_libGTASA + 0x5E551C))();
...
void SetCurrentTxd(int slot)
{
    ...
    ((void (*)(int, int))(g_libGTASA + 0x5E5444))(slot, 0);
}
// 0.3.7 
void PopCurrentTxd()
{
    // CTxdStore::PopCurrentTxd
    ((void (*)())(g_libGTASA + 0x5E554C))();
...
uintptr_t SetTexture(const char* texturename)
{
    ...
    ((void (*)(void*, const char*))(g_libGTASA + 0x5D8E90))((void*)&thiz, texturename);
...
void RemoveObjectInRange(int iModel, VECTOR vecPos, float fRange)
{
    ...
    uintptr_t *pBuildingPool = *(uintptr_t**)(g_libGTASA+0x9E8300);
    ...
    uintptr_t *pDummyPool = *(uintptr_t**)(g_libGTASA+0x9E8310);
    ...
    uintptr_t *pObjectPool = *(uintptr_t**)(g_libGTASA+0x9E8308);
...
{
    // RwTextureDestroy
    ((void(*)(uintptr_t))(g_libGTASA + 0x75D198))(texture);
}
...
void DrawRaster(RwRaster* raster, RECT const& rect)
{
    ...
    ((void(*)(RwRaster*, const RECT&, uint32_t, uint32_t, uint32_t, uint32_t))(g_libGTASA + 0x5D95E0))(raster, rect, white, white, white, white);
    RwRenderStateSet(rwRENDERSTATETEXTURERASTER, raster);
    RwRenderStateSet(rwRENDERSTATEVERTEXALPHAENABLE, (void*)true);
    RwIm2DRenderPrimitive(rwPRIMTYPETRIFAN, (RwIm2DVertex*)(g_libGTASA + 0xCACDA4), 4);
}
...
void DrawTexture(uintptr_t texture, RECT* rect, uint32_t dwColor)
{
    if (texture)
    {
        ...
        ((void(*)(uintptr_t, RECT*, uint32_t*))(g_libGTASA + 0x5D9724))(texture, rect, &dwColor);
    }
}
...
void DrawTextureUV(uintptr_t texture, RECT* rect, uint32_t dwColor, float *uv)
{
    if (texture)
    {
        ...
        ((void(*)(uintptr_t, RECT*, uint32_t*, float, float, float, float, float, float, float, float))
                (g_libGTASA + 0x5D9C58))(texture, rect, &dwColor, uv[0], uv[1], uv[2], uv[3], uv[4], uv[5], uv[6], uv[7]);
    }
}
...
uintptr_t ModelInfoCreateInstance(int iModel)
{
    ...
    if (modelInfo)
    {
        return ((uintptr_t(*)(uintptr_t))*(uintptr_t*)(*(uintptr_t*)modelInfo +  0x2C*2))(modelInfo);
    }
...
void RenderClumpOrAtomic(uintptr_t rwObject)
{
    if (rwObject)
    {
        if (*(uint8_t*)rwObject == 1)
        {
            // Atomic
            FLog("Render Atomic!");
            ((void(*)(uintptr_t))( *(uintptr_t*)(rwObject+0x58) ))(rwObject);
        }
        else if (*(uint8_t*)rwObject == 2)
        {
            FLog("Render Clump!");
            // rpClumpRender
            ((void(*)(uintptr_t))(g_libGTASA + 0x73721C))(rwObject);
        }
    }
}
...
float GetModelColSphereRadius(int iModel)
{
    ...
    if (modelInfo)
    {
        uintptr_t colModel = *(uintptr_t*)(modelInfo + 0x30);
        if (colModel != 0) {
...
void DestroyAtomicOrClump(uintptr_t rwObject)
{
    if (rwObject)
    {
        ...
        {
            // RpAtomicDestroy
            ((void(*)(uintptr_t))(g_libGTASA + 0x7370AC))(rwObject);

            uintptr_t parent = *(uintptr_t*)(rwObject + 9);
            if (parent)
            {
                // RwFrameDestroy
                ((void(*)(uintptr_t))(g_libGTASA + 0x758DE0))(parent);
            }
        ...
        {
            // RpClumpDestroy
            ((void(*)(uintptr_t))(g_libGTASA + 0x73765C))(rwObject);
        }
    }
}
...
void GamePrepareTrain(VEHICLE_TYPE * pGtaVehicle)
{
    ...
    PED_TYPE* pDriver = (PED_TYPE *)pGtaVehicle->pDriver;
    ...
    if (pDriver)
    {
        if (pDriver->dwPedType != 0 && pDriver->dwPedType != 1)
        {
            ...
            ((void (*)(uintptr_t))(g_libGTASA + 0x5A4708))((uintptr_t)pDriver);
...
{
    ((void (*) (MATRIX4X4*, VECTOR*, float, int))(g_libGTASA + 0x74F3A0))(mat, &_axis[axis], angle, 1);
}
// 0.3.7
...
{
    return "/storage/emulated/0/Documents/SampMobile/";
}
// 0.3.7
void RwFrameTranslate(uintptr_t parent, VECTOR* vec, int flag)
{
    // RwFrameTranslate
    ((void(*)(uintptr_t, VECTOR*, int))(g_libGTASA + 0x759120))(parent, vec, flag);
}
// 0.3.7
void RwFrameRotate(uintptr_t frame, int axis, float angle)
{
    // RwFrameRotate
    ((void(*)(uintptr_t, VECTOR*, float, int))(g_libGTASA + 0x7592C4))(frame, &_axis[axis], angle, 1);
}
// 0.3.7
void RpWorldAddLight(uintptr_t light)
{
    ...
    if (pRwWorld) {
        // RpWorldAddLight
        ((void(*)(uintptr_t, uintptr_t))(g_libGTASA + 0x745E54))(pRwWorld, light);
    }
}
// 0.3.7
void RpWorldRemoveLight(uintptr_t light)
{
    ...
    if (pRwWorld) {
        // RpWorldRemoveLight
        ((void(*)(uintptr_t, uintptr_t))(g_libGTASA + 0x745EC0))(pRwWorld, light);
    }
}
...
{
    // CWorld::LineOfSight
    return (( int (*)(VECTOR*, VECTOR*, void*, uintptr_t, char, char, char, char, char, char, char, char))(g_libGTASA+0x4AC534))(start, end, colpoint, ent, buildings, vehicles, peds, objects, dummies, seeThrough, camera, unk);
}

void RwMatrixInvert(MATRIX4X4 *matOut, MATRIX4X4 *matIn)
{
    // RwMatrixInvert
    (( void (*)(MATRIX4X4*, MATRIX4X4*))(g_libGTASA+0x74F474))(matOut, matIn);
}

int GetTaskTypeFromTask(uintptr_t *task)
{
    if(!task || *task < g_libGTASA+0x8073D8 || *task > g_libGTASA+0x8107F0)
        return 0;

    uintptr_t dwTaskVtbl = task[0];
    return (( int (*)(uintptr_t))(*(void**)(dwTaskVtbl+0x28)))(dwTaskVtbl); // CTask*:GetTaskType
}

int Game_PedStatPrim(int model_id)
{
    return ms_modelInfoPtrs[model_id]->AsPedModelInfoPtr()->m_nStatType;
}

uint32_t GetUpperCaseKey(const char* szUpper)
{
    // CKeyGen::GetUpperCaseKey
    return (( uint32_t (*)(const char*))(g_libGTASA+0x478D10))(szUpper);
}
...
bool IsGameEntityArePlaceable(ENTITY_TYPE *pEntity)
{
    ...
    {
        if(pEntity->vtable)
            return (pEntity->vtable == g_libGTASA+0x808818);
    }
...
void RenderEntity(ENTITY_TYPE* entity)
{
    if(entity->m_nType)
    {
        CHook::CallFunction<void>(g_libGTASA + 0x5E5FE8, entity->m_pRpClump);
    }

    // CEntity::PreRender
    ((void (*)(ENTITY_TYPE*))(*(uintptr_t*)( *(uintptr*)(entity) + (VER_x32 ? 0x48 : 0x48*2) )))(entity);

    // CRenderer::RenderOneNonRoad
    (( void (*)(ENTITY_TYPE*))(g_libGTASA + 0x4978E8))(entity);
}