...
{
    CHook::Write(g_libGTASA + 0x821D50, &CTimer::m_CodePause);
    CHook::Write(g_libGTASA + 0x821D70, &CTimer::m_FrameCounter);
    CHook::Write(g_libGTASA + 0x824DC8, &CTimer::game_FPS);
    CHook::Write(g_libGTASA + 0x821D48, &CTimer::m_UserPause);
    CHook::Write(g_libGTASA + 0x8229D0, &CTimer::ms_fTimeScale);
    CHook::Write(g_libGTASA + 0x821C88, &CTimer::m_snTimeInMilliseconds);
    CHook::Write(g_libGTASA + 0x824678, &CTimer::bSkipProcessThisFrame);
    CHook::Write(g_libGTASA + 0x821DE8, &CTimer::ms_fTimeStep);

    CHook::Write(g_libGTASA + 0x8237E0, &CTimer::m_snPPPPreviousTimeInMilliseconds);
    CHook::Write(g_libGTASA + 0x824DB0, &CTimer::m_snPPPreviousTimeInMilliseconds);
    CHook::Write(g_libGTASA + 0x824DB8, &CTimer::m_snPPreviousTimeInMilliseconds);
    CHook::Write(g_libGTASA + 0x822EF8, &CTimer::m_snPreviousTimeInMilliseconds);
    CHook::Write(g_libGTASA + 0x824D98, &CTimer::m_snTimeInMillisecondsNonClipped);
    CHook::Write(g_libGTASA + 0x824DC0, &CTimer::m_snPreviousTimeInMillisecondsNonClipped);

    gTimerRunning = &*(uint8_t*)(g_libGTASA + 0xA00CD4);
...
{
    return CHook::CallFunction<uint32_t>(g_libGTASA + 0x4A7B8C);
}
...
{
    return CHook::CallFunction<uint64_t>(g_libGTASA + 0x4A7BBC);
}
