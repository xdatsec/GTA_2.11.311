...
{
    CHook::CallFunction<void>(g_libGTASA + 0x5D949C, this, x, y, width, height, color);
}
...
void CSprite2d::InjectHooks() {
    CHook::Write(g_libGTASA + 0x821EF0, &CSprite2d::RecipNearClip);
    CHook::Write(g_libGTASA + 0x821EE8, &CSprite2d::NearScreenZ);
}
