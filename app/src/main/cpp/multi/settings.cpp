...
CSettings::CSettings()
{
    ...
    // gui
    length = reader.Get("gui", "Font", "/arial_bold.ttf").copy(m_Settings.szFont, MAX_SETTINGS_STRING);
    ...
    // chat
    m_Settings.fChatPosX = 100.0f;
    m_Settings.fChatPosY = 30.0f;
    m_Settings.fChatSizeX = 500.0f;
    m_Settings.fChatSizeY =130.0f;
    ...
    m_Settings.EnableSpeedo = reader.GetBoolean("gui", "speedo", false);
