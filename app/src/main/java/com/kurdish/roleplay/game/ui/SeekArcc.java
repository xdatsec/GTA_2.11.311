 ...
 *
 */
public class SeekArcc extends View {

    private static final String TAG = SeekArcc.class.getSimpleName();
    ...
    public interface OnSeekArcChangeListener {
        ...
        void onProgressChanged(SeekArcc seekArc, int progress, boolean fromUser);
         ...
         */
        void onStartTrackingTouch(SeekArcc seekArc);
         ...
         *            The SeekArc in which the touch gesture began
         */
        void onStopTrackingTouch(SeekArcc seekArc);
    }

    public SeekArcc(Context context) {
        super(context);
        init(context, null, 0);
    }

    public SeekArcc(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, R.attr.seekArcStyle);
    }

    public SeekArcc(Context context, AttributeSet attrs, int defStyle) {
